          ...
          <div style={{ flex: 1, minWidth: 0, width: "100%" }}>
            {mode === "standard" ? (
              <>
                ...
                <button onClick={handleGenerate} disabled={loading} style={{ ...btnPrimary, width: "100%", padding: "14px 20px", fontSize: 16, opacity: loading ? 0.7 : 1, cursor: loading ? "wait" : "pointer", marginBottom: 18 }}>
